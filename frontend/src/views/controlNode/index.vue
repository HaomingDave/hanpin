  ...
  <div v-loading="loading" class="app-container">
      <el-row class="img-wrapper">
        <el-col v-for="item in fileList" :xs="24" :sm="24" :md="12" :lg="6" class="box">
          ...
          <el-button size="small">
            <a :href="'http://view.xdocin.com/xdoc?_xdoc=' + assetsUrl + item.sgjdkz">
              预览
            </a>
          </el-button>
          <el-button size="small">
            <a :href="assetsUrl + item.sgjdkz">
              下载
            </a>
          </el-button>
        </el-col>
      ...
      <el-row class="">
        <el-col :xs="24" :sm="24" :md="12" :lg="6" class="box" style="border: 0px">
          ...
          <el-button size="small" type="success" :disabled="!file" class="upload-but" @click="uploadZcxm">上传施工节点控制表</el-button>
        </el-col>
      </el-row>
    <div class="foot">
      <el-pagination
